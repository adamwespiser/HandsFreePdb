...
inFile <- "/home/adam/work/kinect/analysis/data/tmp_save2.csv"
...
df <- read.csv(file=inFile,stringsAsFactors=FALSE) 
start_site=175
canonical_taps
#canonical_taps <-c(200,240,280,319,355,400,435,476,513,553,589,635,669,715,745,787,821,862,902,940,982,1020,1060,1100,1180,1220,1255,1290,1330,1370,1410,1450,1485,1425,1570,1605,1645,1680,1720,1760,1800,1840,1880,1920,1955,1990,1935,2065,2112,2150,2190) - 180
...
df.plot <- melt(df[c("h1x_velocity","h1y_velocity","h1z_velocity","h1vel","h2vel","h1y_cg","h1z_cg","tap_detected","time","still")],id.var=c("time","still"))
